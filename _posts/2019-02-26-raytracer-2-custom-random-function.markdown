...
[clock API](http://www.cplusplus.com/reference/ctime/clock/){:target="_blank"} instead of using some
...
[Xorshift](https://en.wikipedia.org/wiki/Xorshift){:target="_blank"} is a random number generator
